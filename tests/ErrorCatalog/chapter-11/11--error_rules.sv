...
:description: IEEE 1800-2023 Clause 11 error scenarios
:tags: 11.3.6 11.4.12 11.4.12.1 11.4.12.2 11.4.14 11.12
*/
...
//
// All seven scenarios below are Category COMP or LINT (context/semantic
// rules, not PA_SYNTAX_ERROR), so every one of them parses cleanly on its
// own -- there was no need to split any scenario into a sibling _invK.sv
// fixture, unlike chapter-3.
