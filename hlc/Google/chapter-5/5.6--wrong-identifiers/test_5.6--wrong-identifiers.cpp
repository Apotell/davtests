...
// ----
// Per IEEE 1800-2023 Sec 5.6 (simple_identifier grammar, Annex A.9.3), the
// first character of a simple identifier must be [a-zA-Z_]; '$' and digits
// are not legal leading characters. `reg $dollar;` and `reg 0number;` are
