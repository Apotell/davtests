...
TEST_F(StructureReplication, XYZTypespecHasThreeMembers) {
  ...
  const hldb::StructTypespec *const st =
      any_cast<hldb::StructTypespec>(xyz->getTypespec()->getActual());
...
TEST_F(StructureReplication, AbTStructHasTwoMembers) {
  ...
  const hldb::StructTypespec *const st =
      any_cast<hldb::StructTypespec>(abT->getTypedefAlias()->getActual());
...
TEST_F(StructureReplication, V1TypespecIsArray) {
  ...
  const hldb::ArrayTypespec *const at =
      any_cast<hldb::ArrayTypespec>(v1->getTypespec()->getActual());
...
TEST_F(StructureReplication, NestedReplicationLevelsAreAssignPatterns) {
  ...
  const hldb::Operation *const l1 =
      any_cast<hldb::Operation>((*l0->getOperands())[1]);
  ...
  const hldb::Operation *const l2 =
      any_cast<hldb::Operation>((*l1->getOperands())[1]);
  ...
  const hldb::Operation *const l3 =
      any_cast<hldb::Operation>((*l2->getOperands())[1]);
