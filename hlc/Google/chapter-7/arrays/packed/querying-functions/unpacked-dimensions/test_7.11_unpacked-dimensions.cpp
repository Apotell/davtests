...
// Tests for unpacked-dimensions.sv (tags: 7.11 7.4.1)
//   module top ();
//     bit [7:0] arr;
//     initial begin
...
//
//  checked:
//   - actual runtime value returned by $unpacked_dimensions(arr) --
...
class PackedQueryUnpackedDimensionsTest : public Test {
 public:
  static void SetUpTestSuite() { Compile(__FILE__, {"-f", "unpacked-dimensions.hlc"}); }
...
TEST_F(PackedQueryUnpackedDimensionsTest, DesignHasStringTypespec) {
  ASSERT_NE(m_design->getTypespecs(), nullptr);
  EXPECT_NE(any_cast<hldb::StringTypespec>(m_design->getTypespecs()->at(2)), nullptr);
}

TEST_F(PackedQueryUnpackedDimensionsTest, CompilerReportsZeroErrors) {
...
TEST_F(PackedQueryUnpackedDimensionsTest, RuntimeUnpackedDimensionsValueRequiresSimulation) {
  ...
  //                 "simulator, so the actual runtime value returned by $unpacked_dimensions(arr) "
