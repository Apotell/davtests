...
// Tests for high.sv (tags: 7.11 7.4.1)
//   module top ();
//     bit [7:0] arr;
//     initial begin
...
//
//  checked:
//   - actual runtime value returned by $high(arr) -- simulation-only 
...
class PackedQueryHighTest : public Test {
 public:
  static void SetUpTestSuite() { Compile(__FILE__, {"-f", "high.hlc"}); }
...
TEST_F(PackedQueryHighTest, DesignHasStringTypespec) {
  ASSERT_NE(m_design->getTypespecs(), nullptr);
  EXPECT_NE(any_cast<hldb::StringTypespec>(m_design->getTypespecs()->at(2)), nullptr);
}

TEST_F(PackedQueryHighTest, CompilerReportsZeroErrors) {
