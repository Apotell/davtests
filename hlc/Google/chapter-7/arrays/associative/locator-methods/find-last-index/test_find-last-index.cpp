...
TEST_F(ArrayLocatorFindLastIndexTest, NetQiTypespecIsStaticArray) {
...
TEST_F(ArrayLocatorFindLastIndexTest, CompilerReportsExactlyTwoErrorsNoFatalNoWarning) {
...
TEST_F(ArrayLocatorFindLastIndexTest, ExactlyTwoIllegalImplicitNetErrors) {
  ...
  EXPECT_EQ(implicitNetErrors[0].getLocations()[0].m_column, 32u);
