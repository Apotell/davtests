...
//   COMP_FAILED_TO_BIND; (3) the pattern-bound "v" referenced in case
...
TEST_F(CasezPatternTest, CaseExpressionVIsUndeclaredAndFailsToBind) {
  GTEST_SKIP() << "Confirmed HLC bug -- verified by running this test with the skip removed (fails as expected): "
                  "'casez (v)' reads an identifier declared nowhere in this module, which must fail to bind and "
                  "be diagnosed, but HLC reports zero diagnostics for it. Same underlying gap as "
                  "12.6.1--case_pattern.cpp/casex_pattern.cpp and 6.10--implicit_continuous_assignment.cpp. "
