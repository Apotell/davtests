...
//     Variable "a", vpiIndexedPartSelectType == vpiPosIndexed
//     (distinguishing this construct from the "-:"/neg-indexed and plain
//     "[msb:lsb]" forms), vpiBaseExpr Constant "11", vpiWidthExpr Constant
//     "4"
...
TEST_F(IdxPosPartSelectTest, ModuleHasTwoVectorVariablesNeitherDeclAssigned) {
