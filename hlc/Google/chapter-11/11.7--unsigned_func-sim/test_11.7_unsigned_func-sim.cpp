...
//
// Checked:
//   - module top has exactly 1 net: "a" (LogicTypespec, vector [7:0], not
//     signed), not decl-assigned
...
//   - the Assignment: lhs RefObj "a"; rhs SysTaskCall "$unsigned" with 1
...
TEST_F(UnsignedFuncSimTest, ModuleHasOneUnsignedVectorNetNotDeclAssigned) {
...
TEST_F(UnsignedFuncSimTest, AEqualsTwoHundredFiftyTwoAtRuntime) {
  GTEST_SKIP() << "IEEE 1800-2017 11.7: $unsigned(-4) reinterprets -4 as an "
                  ...
                  "initializer, and 'a' is only assigned inside the initial "
                  "block, never at declaration -- there is no field "
