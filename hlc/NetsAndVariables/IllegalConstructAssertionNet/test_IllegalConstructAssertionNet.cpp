...
class IllegalConstructAssertionNetTest : public Test {
 public:
  static void SetUpTestSuite() { Compile(__FILE__, {"-f", "IllegalConstructAssertionNet.hlc"}); }
  static void TearDownTestSuite() { Shutdown(); }
};

TEST_F(IllegalConstructAssertionNetTest, NetLocalVariableInPropertyIsRejected) {
