...
TEST_F(NetsAndVariablesNonAnsi, ProgramExists) {
  ...
  EXPECT_NE(hldb::findByName<hldb::Program>("nets_and_variables_program", m_design->getAllPrograms()), nullptr);
}
...
TEST_F(NetsAndVariablesNonAnsi, ModportInterfaceExists) {
  EXPECT_NE(
      hldb::findByName<hldb::Interface>("nets_and_variables_modport_if_nonansi", m_design->getAllInterfaces()),
      nullptr);
}
...
TEST_F(NetsAndVariablesNonAnsi, ModportInterfaceHasNetAndVariable) {
  const hldb::Interface *const iface = hldb::findByName<hldb::Interface>(
      "nets_and_variables_modport_if_nonansi", m_design->getAllInterfaces());
  ASSERT_NE(iface, nullptr);
...
TEST_F(NetsAndVariablesNonAnsi, ClassExists) {
  ...
  EXPECT_NE(hldb::findByName<hldb::ClassDefn>("nets_and_variables_class_nonansi", m_design->getAllClasses()),
            nullptr);
}

TEST_F(NetsAndVariablesNonAnsi, ClassHasVariables) {
  const hldb::ClassDefn *const cls =
      hldb::findByName<hldb::ClassDefn>("nets_and_variables_class_nonansi", m_design->getAllClasses());
...
TEST_F(NetsAndVariablesNonAnsi, AssertionModuleExists) {
  EXPECT_NE(
      hldb::findByName<hldb::Module>("nets_and_variables_assertion_nonansi", m_design->getAllModules()),
      nullptr);
}
