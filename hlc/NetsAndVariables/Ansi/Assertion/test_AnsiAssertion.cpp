...
//
// Checked:
//   - work@nets_and_variables_assertion exists with three input ports
//     (clk, a, b)
...
class AnsiAssertionTest : public Test {
 public:
  static void SetUpTestSuite() { Compile(__FILE__, {"-f", "AnsiAssertion.hlc"}); }
  static void TearDownTestSuite() { Shutdown(); }

 protected:
  static const hldb::Module *getTop() {
    return hldb::findByName<hldb::Module>("work@nets_and_variables_assertion", m_design->getAllModules());
  }
};
