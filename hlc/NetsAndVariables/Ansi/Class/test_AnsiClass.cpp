...
//
// Checked:
//   - the file-scope class is NOT checked structurally: no test anywhere in
//     this suite demonstrates reaching a file-scope (non-nested)
//     hldb::ClassDefn from the Design; left as a documented GTEST_SKIP
...
TEST_F(AnsiClassTest, ClassDeclarationNotStructurallyChecked) {
