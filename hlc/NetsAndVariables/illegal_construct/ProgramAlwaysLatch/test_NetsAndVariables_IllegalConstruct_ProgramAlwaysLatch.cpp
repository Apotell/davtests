...
class ProgramAlwaysLatchTest : public Test {
 public:
  static void SetUpTestSuite() { Compile(__FILE__, {"-f", "ProgramAlwaysLatch.hlc"}); }
  static void TearDownTestSuite() { Shutdown(); }
};

TEST_F(ProgramAlwaysLatchTest, AlwaysLatchInProgramIsRejected) {
