...
class ProceduralAssignmentUndeclaredTest : public Test {
 public:
  static void SetUpTestSuite() { Compile(__FILE__, {"-f", "ProceduralAssignmentUndeclared.hlc"}); }
  static void TearDownTestSuite() { Shutdown(); }
};

TEST_F(ProceduralAssignmentUndeclaredTest, ProceduralAssignmentToUndeclaredIsRejected) {
