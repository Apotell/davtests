...
//
// Checked:
//   - work@nets_and_variables_assertion_nonansi exists with three input
//     ports (clk, a, b)
...
class NonAnsiAssertionTest : public Test {
 public:
  static void SetUpTestSuite() { Compile(__FILE__, {"-f", "NonAnsiAssertion.hlc"}); }
  static void TearDownTestSuite() { Shutdown(); }

 protected:
  static const hldb::Module *getTop() {
    return hldb::findByName<hldb::Module>("work@nets_and_variables_assertion_nonansi", m_design->getAllModules());
  }
};
