...
//
// Checked:
//   - nets_and_variables_class_nonansi exists via Design::getAllClasses()
...
TEST_F(NonAnsiClassTest, ClassExists) {
  ...
  EXPECT_NE(hldb::findByName<hldb::ClassDefn>("nets_and_variables_class_nonansi", m_design->getAllClasses()), nullptr);
}

TEST_F(NonAnsiClassTest, ClassHasVariables) {
...
TEST_F(NonAnsiClassTest, ClassHasRandVariables) {
