...
//
// Checked:
//   - work@nets_and_variables_modport_if_nonansi exists, with net mp_net and
...
class NonAnsiModportTest : public Test {
 public:
  static void SetUpTestSuite() { Compile(__FILE__, {"-f", "NonAnsiModport.hlc"}); }
  static void TearDownTestSuite() { Shutdown(); }

 protected:
  static const hldb::Interface *getIface() {
    return hldb::findByName<hldb::Interface>("work@nets_and_variables_modport_if_nonansi",
                                              m_design->getAllInterfaces());
  }
};
