...
class IllegalConstructDefaultNettypeNoneGateTerminalTest : public Test {
 public:
  static void SetUpTestSuite() {
    Compile(__FILE__, {"-f", "IllegalConstructDefaultNettypeNoneGateTerminal.hlc"});
  }
  static void TearDownTestSuite() { Shutdown(); }
};

TEST_F(IllegalConstructDefaultNettypeNoneGateTerminalTest, UndeclaredGateTerminalNetIsRejected) {
