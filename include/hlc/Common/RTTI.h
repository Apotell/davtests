...
#define SURELOG_IMPLEMENT_RTTI(classType, baseType) UHDM_IMPLEMENT_RTTI(classType, baseType)
...
#define SURELOG_IMPLEMENT_RTTI_CAST_FUNCTIONS(fname, baseType) UHDM_IMPLEMENT_RTTI_CAST_FUNCTIONS(fname, baseType)
