...
class Session final {
 public:
  Session();
  Session(FileSystem *fileSystem, SymbolTable *symbolTable, ErrorContainer *errorContainer,
          CommandLineParser *commandLineParser, Precompiled *precompiled, Logger *logger);
