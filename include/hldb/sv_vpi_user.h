...
#define vpiPackageTypespec                      778 /* !!! NOT Standard !!! */

#define vpiLabel                                791
#define vpiEndLabel                             792
#define vpiTaskFuncDecl                         793 /* !!! NOT Standard !!! */
#define vpiFuncDecl                             794 /* !!! NOT Standard !!! */
#define vpiTaskDecl                             795 /* !!! NOT Standard !!! */
#define vpiFunctionDecl                         796 /* !!! NOT Standard !!! */
...
#define vpiOneStepConst                          10
#define vpiUnboundedConst                        11
#define vpiNullConst                             12
#define vpiScalarConst                           13
...
#define vpiAcceptOnOp                            53 /* accept_on operator */
#define vpiRejectOnOp                            54 /* reject_on operator */
#define vpiSyncAcceptOnOp                        55 /* sync_accept_on operator */
#define vpiSyncRejectOnOp                        56 /* sync_reject_on operator */
#define vpiOverlapFollowedByOp                   57 /* overlapped followed_by operator */
#define vpiNonOverlapFollowedByOp                58 /* nonoverlapped followed_by operator */
#define vpiNexttimeOp                            59 /* nexttime operator */
#define vpiAlwaysOp                              60 /* always operator */
#define vpiEventuallyOp                          61 /* eventually operator */
#define vpiUntilOp                               62 /* until operator */
#define vpiUntilWithOp                           63 /* until_with operator */

#define vpiPostIncOp                             64 /* ++ post-increment */
#define vpiPreIncOp                              65 /* ++ pre-increment */
#define vpiPostDecOp                             66 /* -- post-decrement */
#define vpiPreDecOp                              67 /* -- pre-decrement */

#define vpiStreamLROp                            68 /* left-to-right streaming {>>} operator */
#define vpiStreamRLOp                            69 /* right-to-left streaming {<<} operator */

#define vpiUnaryCycleDelayOp                     70 /* binary cycle delay (##) operator */
#define vpiCycleDelayOp                          71 /* binary cycle delay (##) operator */
#define vpiIntersectOp                           72 /* intersection operator */
#define vpiFirstMatchOp                          73 /* first_match operator */
#define vpiThroughoutOp                          74 /* throughout operator */
#define vpiWithinOp                              75 /* within operator */
#define vpiRepeatOp                              76 /* [=] nonconsecutive repetition */
#define vpiConsecutiveRepeatOp                   77 /* [*] consecutive repetition */
#define vpiGotoRepeatOp                          78 /* [->] goto repetition */

#define vpiMatchOp                               80 /* match() operator */
#define vpiCastOp                                81 /* type'() operator */
#define vpiIffOp                                 82 /* iff operator */
#define vpiWildEqOp                              83 /* ==? operator */
#define vpiWildNeqOp                             84 /* !=? operator */

#define vpiMatchedOp                             85 /* the .matched sequence operation */
#define vpiTriggeredOp                           86 /* the .triggered sequence operation */
#define vpiAssignmentPatternOp                   87 /* '{} assignment pattern */
#define vpiMultiAssignmentPatternOp              88 /* '{n{}} multi assignment pattern */
#define vpiIfOp                                  89 /* if operator */
#define vpiIfElseOp                              90 /* if-else operator */
#define vpiCompAndOp                             91 /* Composite and operator */
#define vpiCompOrOp                              92 /* Composite or operator */
#define vpiImpliesOp                             93 /* implies operator */
#define vpiInsideOp                              94 /* inside operator */
#define vpiTypeOp                                95 /* type operator */
#define vpiAssignmentOp                          96 /* Normal assignment */
